...
<script id="basket-total-template" type="text/html">
		...
		<div class="cart__order-sum-list basket-checkout-section">
			<div class="basket-checkout-section-inner">
				<div class="basket-checkout-block basket-checkout-block-total">
					<div class="basket-checkout-block-total-inner">
						<div class="cart__order-text basket-checkout-block-total-title"><?=Loc::getMessage('SBB_TOTAL')?>:</div>
            ...
            <div class="basket-checkout-block basket-checkout-block-total-price">
                <div class="basket-checkout-block-total-price-inner">
                    ...
                    <div class="cart__order-sum basket-coupon-block-total-price-current" data-entity="basket-total-price">
                        {{{PRICE_FORMATED}}}
                    </div>
    ...
    <div class="cart__row-base-btn">
        ...
        <div class="basket-checkout-block basket-checkout-block-btn">
            <button class="cart__btn_red btn btn-lg btn-default basket-btn-checkout{{#DISABLE_CHECKOUT}} disabled{{/DISABLE_CHECKOUT}}"
